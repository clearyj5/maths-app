...
```json
{
  ...
  "solutionSteps": [
    { "step": "Identify the formula", "explanation": "Use the cosine rule: $c^2 = a^2 + b^2 - 2ab\\cos C$" },
    { "step": "Substitute values", "explanation": "$c^2 = 7^2 + 5^2 - 2(7)(5)\\cos(52°) = 49 + 25 - 70\\cos(52°)$" },
